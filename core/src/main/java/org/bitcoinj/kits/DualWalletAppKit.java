 ...
 */
public class DualWalletAppKit extends AbstractIdleService {
    protected static final Logger log = LoggerFactory.getLogger(DualWalletAppKit.class);
     ...
     */
    public DualWalletAppKit(NetworkParameters params, File directory, String filePrefix) {
     ...
     */
    public DualWalletAppKit(Context context, File directory, String filePrefix) {
    ...
    public DualWalletAppKit setPeerNodes(PeerAddress... addresses) {
    ...
    public DualWalletAppKit connectToLocalHost() {
        try {
    ...
    public DualWalletAppKit setAutoSave(boolean value) {
        checkState(state() == State.NEW, "Cannot call after startup");
        useAutoSave = value;
        return this;
    }
     ...
     */
    public DualWalletAppKit setDownloadListener(DownloadProgressTracker listener) {
        this.downloadListener = listener;
        return this;
    }

    /** If true, will register a shutdown hook to stop the library. Defaults to true. */
    public DualWalletAppKit setAutoStop(boolean autoStop) {
     ...
     */
    public DualWalletAppKit setCheckpoints(InputStream checkpoints) {
     ...
     */
    public DualWalletAppKit setBlockingStartup(boolean blockingStartup) {
     ...
     */
    public DualWalletAppKit setUserAgent(String userAgent, String version) {
     ...
     */
    public DualWalletAppKit useTor() {
        this.useTor = true;
        return this;
    }
     ...
     * time).
     */
    public DualWalletAppKit restoreWalletFromSeed(DeterministicSeed seed) {
     ...
     */
    public DualWalletAppKit setDiscovery(@Nullable PeerDiscovery discovery) {
    ...
    protected Wallet createWallet() {
        KeyChainGroup kcg;
        if (restoreFromSeed != null)
            kcg = new DualKeyChainGroup(params, restoreFromSeed);
        else
            kcg = new DualKeyChainGroup(params);
        if (walletFactory != null) {
    ...
    private void installShutdownHook() {
        if (autoStop) Runtime.getRuntime().addShutdownHook(new Thread() {
            @Override public void run() {
                try {
                    DualWalletAppKit.this.stopAsync();
                    DualWalletAppKit.this.awaitTerminated();
                } catch (Exception e) {
                    throw new RuntimeException(e);
                }
            }
