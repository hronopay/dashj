...
import org.bitcoinj.kits.DualWalletAppKit;
 ...
 */
public class DualWalletForwardingService {
    private static Address forwardingAddress;
    private static DualWalletAppKit kit;
    ...
    public static void main(String[] args) throws Exception {
        ...
        kit = new DualWalletAppKit(params, new File("."), filePrefix);
